...
mountStorageContainer(storageAccount,storageAccountKey,"staging","/mnt/data/crimes/stagingDir")
mountStorageContainer(storageAccount,storageAccountKey,"raw","/mnt/data/crimes/rawDir")
mountStorageContainer(storageAccount,storageAccountKey,"curated","/mnt/data/crimes/curatedDir")
mountStorageContainer(storageAccount,storageAccountKey,"consumption","/mnt/data/crimes/consumptionDir")
...
display(dbutils.fs.ls("/mnt/data/crimes/"))
