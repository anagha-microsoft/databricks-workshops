...
// MAGIC %md
// MAGIC # CosmosDB Cassandra API
// MAGIC 
// MAGIC CosmosDB Cassandra API allows you to interact with CosmosDB using Cassandra constructs/codebase. CosmosDB is a managed service, therefore, not all functionality available in Cassandra is applicable for the Cassandra API for CosmosDB.  E.g. CosmosDB has its own replication,indexing etc that is not overridable.<br><br>
// MAGIC 
// MAGIC Documentation: **TODO** - add link here<br>
// MAGIC 
// MAGIC This module covers:<br>
// MAGIC 1) Provisioning CosmosDb - Cassandra API<br>
// MAGIC 2) CosmosDB configuration needed for Spark integration<br>
// MAGIC 3) Attaching Spark-Cassandra connector library to the cluster<br>
// MAGIC 4) Attaching CosmosDB Spark-Cassandra specific library<br>
// MAGIC 5) Cluster-wide configuration of CosmosDB instance details<br>
...
// MAGIC %md
// MAGIC ### 2.0. CosmosDB instance related configuration needed for Spark integration
...
// MAGIC To work with CosmosDB Cassandra API, we have to attach the Datastax Cassandra connector the cluster.<br>
...
// MAGIC %md
// MAGIC ### 5.0. Cluster-wide configuration of CosmosDB instance details
// MAGIC With Spark 2.x, the entry point is Spark session.<br>
// MAGIC With the Datastax Spark connector, th dataframe API can read configuration off of that defined at a spark session level within notebook.<br>
...
// MAGIC %md
// MAGIC ### 7.0. Using cqlsh with CosmosDB Cassandra API
// MAGIC If you are particular about using cqlsh, you can install a pseudo-distrubuted Cassandra instance on your machine, and launch cqlsh against CosmosDB-Cassandra API instance.<br><br>
...
// MAGIC 
// MAGIC <br>
// MAGIC **2) Launching cqlsh against CosmosDB Cassandra API:**<bin>
// MAGIC <code>
// MAGIC cd bin<br>
