...
// MAGIC %fs
// MAGIC ls /mnt/data/movielens/scratchDir

// COMMAND ----------

// MAGIC %fs
// MAGIC mkdirs /mnt/data/movielens/scratchDir/testDir/hiveTableTest

// COMMAND ----------

// MAGIC %fs
// MAGIC ls /mnt/data/movielens/scratchDir/testDir/

// COMMAND ----------

if (dbutils.fs.cp("file:/tmp/us_states.csv","/mnt/data/movielens/scratchDir/testDir/hiveTableTest"))
  dbutils.fs.rm("file:/tmp/us_states.csv",recurse=true)


// COMMAND ----------

dbutils.fs.ls("/mnt/data/movielens/scratchDir/testDir/hiveTableTest/")
...
// MAGIC location "/mnt/data/movielens/scratchDir/testDir/hiveTableTest/";
