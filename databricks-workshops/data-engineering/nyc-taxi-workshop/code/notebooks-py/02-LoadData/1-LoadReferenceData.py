...
# MAGIC %fs ls /mnt/<userid>/data/nyctaxi/stagingDir/reference-data

# COMMAND ----------

# Define source and destination directories
srcDataDirRoot = "/mnt/<userid>/data/nyctaxi/stagingDir/reference-data/" #Root dir for source data
destDataDirRoot = "/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>/" #Root dir for consumable data
...
display(dbutils.fs.ls("/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>"))
...
# MAGIC USING parquet
# MAGIC LOCATION '/mnt/<userid>/data/nyctaxi/referenceDataDir/taxi-zone/';
...
# MAGIC USING parquet
# MAGIC LOCATION '/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>/trip-month/';
...
# MAGIC USING parquet
# MAGIC LOCATION '/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>/rate-code/';
...
# MAGIC description STRING)
# MAGIC USING parquet
# MAGIC LOCATION '/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>/payment-type/';
...
# MAGIC description STRING)
# MAGIC USING parquet
# MAGIC LOCATION '/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>/trip-type/';
...
# MAGIC description STRING)
# MAGIC USING parquet
# MAGIC LOCATION '/mnt/<userid>/data/nyctaxi/referenceDataDir/<userid>/vendor/';
...
# MAGIC %scala
# MAGIC analyzeTables("<userid>_taxi_db.vendor_lookup")
# MAGIC analyzeTables("<userid>_taxi_db.trip_type_lookup")
# MAGIC analyzeTables("<userid>_taxi_db.payment_type_lookup")
# MAGIC analyzeTables("<userid>_taxi_db.rate_code_lookup")
# MAGIC analyzeTables("<userid>_taxi_db.trip_month_lookup")
# MAGIC analyzeTables("<userid>_taxi_db.taxi_zone_lookup")