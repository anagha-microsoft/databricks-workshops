...
val deltaTableDirectory = "/mnt/data/workshop/curatedDir/delta/books"
...
// MAGIC USING DELTA
// MAGIC LOCATION "/mnt/data/workshop/curatedDir/delta/books";
...
display(dbutils.fs.ls("/mnt/data/workshop/curatedDir/delta/books"))
...
booksOverwriteDF.write.format("delta").mode("overwrite").save("/mnt/data/workshop/curatedDir/delta/books")
...
booksNewColDF.write
  ...
  .mode("append")
  .save("/mnt/data/workshop/curatedDir/delta/books")
...
dbutils.fs.rm("/mnt/data/workshop/curatedDir/delta/books-part", recurse=true)

booksPartitionedDF.write
  .format("delta")
  .partitionBy("book_author")
  .save("/mnt/data/workshop/curatedDir/delta/books-part")
...
// MAGIC USING DELTA
// MAGIC LOCATION "/mnt/data/workshop/curatedDir/delta/books-part";
