...
// MAGIC https://github.com/anagha-microsoft/databricks-workshops/blob/master/iot/docs/Provisioning-5-Kafka.md
...
// MAGIC https://github.com/anagha-microsoft/databricks-workshops/blob/master/iot/docs/Provisioning-5-Kafka.md<br><br>
// MAGIC 
// MAGIC In the author's case - the broker list, with post (9092) was:<br>
